    ...
    <div className="lp">
      ...
      <nav className="lp-nav" id="lp-top">
       ...
       <div className="lp-nav-links">
        <a href="#how-it-works" className="lp-nav-hide-mobile">{t("navHowItWorks")}</a>
        <a href="#about" className="lp-nav-hide-mobile">{t("navAbout")}</a>
        <a href="#resilient-city" className="lp-nav-hide-mobile">{t("navResilientCity")}</a>
        <button className="lp-lang-toggle" onClick={toggleLang} aria-label="Toggle language">
          {lang === "en" ? "EN → 日本語" : "日本語 → EN"}
        </button>
        <Link to="/start" className="lp-nav-login">{t("navLogIn")}</Link>
        ...
        <div className="lp-hero-text">
          <h1>{t("heroTitle")}</h1>
            ...
            <div className="lp-hero-actions">
              <Link to="/start" className="lp-btn-primary">{t("getStarted")}
      ...
      <div className="lp-footer-top-row">
        <div className="lp-footer-legal-btns">
          <Link to="/terms" className="lp-footer-legal-btn">Terms &amp; Conditions</Link>
          <Link to="/privacy" className="lp-footer-legal-btn">Privacy Policy</Link>
        </div>
