...
export default function CitizenLogin() {
  ...
  return (
    <div className="page-wrap">
      ...
      <RoleBadge role="citizen" label="Citizen sign in" />
      {error && <p className="error-text">{error}</p>}
      <form onSubmit={handleSubmit}>
        <div className="field-group">
          <label className="field-label" htmlFor="citizen-email">Email</label>
          <input id="citizen-email" className="field" type="email" autoComplete="email" placeholder="you@example.com" value={email} onChange={(e) => setEmail(e.target.value)} required />
        </div>
